...
;(function(factory) { // eslint-disable-line no-extra-semi
   ...
   // autosubmit of exposed form on filter value changed : added Mangesh 
   $(document).ajaxComplete(function(event, xhr, settings) {
        $(".views-exposed-form .form-submit").css('display','none');
        $(".views-exposed-form").css('text-align','center');    
        $(".views-exposed-form .form-select").change(
        ...
        function(){
           $("#slickQuiz-name").css('display','none');
           $(".views-exposed-form").css('display','none');
           $(".quizDescription").css('display','none');
           $(".quick-quiz a.startQuiz").css('display','none','!important');
           }
        );
